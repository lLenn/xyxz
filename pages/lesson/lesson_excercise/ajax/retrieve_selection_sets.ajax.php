...
if(Session::get_user_id())
{
	...
	echo '<a id="search_selection_sets_again" class="link_button" href="javascript:;" style="float: right; margin: 3px;">' . Language::get_instance()->translate(118) . '</a>';								
	echo $gm->get_lesson_excercise_manager()->get_renderer()->get_selection_sets_form($qm, RightManager :: READ_RIGHT, true);
}
