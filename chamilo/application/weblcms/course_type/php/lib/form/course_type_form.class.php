...
use application\weblcms\CommonCourseForm;
use application\weblcms\FormLockedSettingsSupport;
...
class CourseTypeForm extends CommonCourseForm implements FormLockedSettingsSupport
{
    ...
    public function build_general_tab_form_elements()
    {
        ...
        $this->addElement(
            'checkbox', CourseType :: PROPERTY_ACTIVE, Translation :: get('CourseTypeActive'), '', null, '1', '0'
        );
