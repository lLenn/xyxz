if(typeof require !== "undefined") {
	var ObjectRuleExpectation = require("./expectations/nixpsit-unit-ObjectRuleExpectation.js");
	var RuleExpectation = require("./expectations/nixpsit-unit-RuleExpectation.js");
...
(function() {
	...
	Rule.prototype = {
		...
		expect: function(pCustomTest) {
			...
			} else if(this.property.type === RuleProperty.WIDGET_OPTION || this.property.type === RuleProperty.WIDGET_VARIABLE) {
