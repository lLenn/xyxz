...
class Lesson
{
	   ...
	   public function set_theme_ids($theme_ids) { $this->theme_ids = $theme_ids; }
		public function get_theme_ids() 
		{
			if(is_null($this->theme_ids))
			{
				...
				$this->theme_ids = LessonDataManager::instance(null)->retrieve_lesson_themes_by_lesson_id($this->id);
			}
		...
		public function get_themes()
		{
			if(!is_null($this->get_theme_ids()) && !empty($this->theme_ids))
			{
				...
				uasort($themes, array('ThemeRenderer', 'order_by_name'));
		...
		public function get_user_ids() 
		{
			...
			{
				require_once Path :: get_path() . "pages/lesson/lib/lesson_data_manager.class.php";
				$this->user_ids = LessonDataManager::instance(null)->retrieve_lesson_relations_by_lesson_id($this->id, $this->user_id);
			}
	   ...
	   public function get_teaser_free(){return $this->teaser_free;}
	   public function set_teaser_free($teaser_free){$this->teaser_free = $teaser_free;}
	   ...
	   public function get_criteria_lesson_excercise_ids()
	   {
	   		...
	   		{
	   			$this->criteria_lesson_excercise_ids = LessonDataManager::instance(null)->retrieve_lesson_meta_data_criteria_excercise_ids($this->id, $this->user_id);
	   		}
	   ...
	   {
	   		$count = count($this->get_criteria_lesson_excercise_ids());
	   		return $this->criteria_lesson_id || $count;
	   }
	   ...
	   public function get_criteria_visible_text_details()
	   {
	   		...
	   		if($this->criteria_lesson_id || $total)
	   		{
	   			if($this->criteria_lesson_id)
	   			{
